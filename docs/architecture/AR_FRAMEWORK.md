...
现已增加双端 DataChannel、相机接管、GPU 视频投递、H264 帧身份、通话双角色入口和基础空间标记叠加；最新接入与验证状态见 1.3–1.5 节。作者/编号/权限快照、邀请/交换、完整双设备 M5 验收及 M3 屏幕共享仍待完成，因此 M4/M5 的产品退出条件尚未达到。产品交互范围以 [AR 现场协作交互专项设计](../product/AR_INTERACTION.md) 为准。
