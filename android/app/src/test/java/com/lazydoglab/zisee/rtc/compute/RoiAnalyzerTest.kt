...
class RoiAnalyzerTest {
    ...
    @Test fun boundsWallAndFrameAgeAndDoesNotReuseFutureDetection() {
        ...
        RoiAnalyzer(detector, { fail(it) }, clock::get).use { analyzer ->
            ...
            assertNotNull(analyzer.regions(geometry, 150_000_100, 150_000_000))
            assertNull(analyzer.regions(geometry, 150_000_101, 150_000_000))
            clock.set(150_001_001)
            assertNull(analyzer.regions(geometry, 100, 150_000_000))
            clock.set(1_000)
