...
enum class AppEvent { RTC_NETWORK_CHANGED, RTC_NETWORK_MONITOR_FAILED, RTC_ICE_RESTART, IDENTITY_READ_FAILED, IDENTITY_WRITE_FAILED, SESSION_LOGOUT_FAILED,
    AR_CHANNEL_FAILED,
    RTC_VIDEO_BANDWIDTH_MODE, RTC_HANDOVER, RTC_HANDOVER_VIDEO, RTC_QUALITY_RESTORED, RTC_LOCAL_CANDIDATE, RTC_BITRATE_SEEDED, RTC_TURN_PERMISSION_PRUNED, RTC_ROUTE_UNREACHABLE,
